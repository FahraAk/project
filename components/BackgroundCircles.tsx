...
function BackgroundCircles({}: Props) {
	return (
		...
		>
			<div className="absolute border  border-[#2acef3] rounded-full h-[200px] w-[200px] mt-52 animate-ping" />
			...
			<div className="border border-[#2acef3] rounded-full h-[650px] w-[650px] mt-52 absolute" />
